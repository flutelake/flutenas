<script lang='ts'>
    ...
    function submit(e :any) {
        ...
        api.post("/v1/samba-user/delete", {'ID': user.ID}).then((resp) => {
...
<Modal bind:open={open} size="xs" autoclose>
    <div class="text-center">
        ...
        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this samba user: {user.Username} ?</h3>
