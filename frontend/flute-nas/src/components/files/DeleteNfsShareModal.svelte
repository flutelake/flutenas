...
<Modal bind:open={open} size="xs" autoclose>
    <div class="text-center">
        ...
        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this NFS share: {shareName} ?</h3>
